...
# Om listan har jämnt antal element ska funktionen returnera medelvärdet av de två
# mittersta talen. Formulera de krav och acceptanskriterier (AK) som ska gälla för funktionen.

# Svar 3a:
# acceptanskriterie 1. Returnera mittersta talet i listan.
# acceptanskriterie 2. Returnera medelvärde av de två mittersta talen om listan har jämnt antal element.

# 3b: Skriv testfall som testar alla AK.
# Svar 3b: Se ../test/test_uppgift_2_3.py
